...
\institute[shortinst]{\inst{1} University of Mannheim \samelineand \inst{2} Another Institute}
...
\logoleft{\includegraphics[height=7cm]{media/07_Logo_Fakultaet_WIM_EN_Weiss.png}}
